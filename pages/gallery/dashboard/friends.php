...
hj_gallery_register_dashboard_title_buttons('friends');

$viewer = elgg_get_logged_in_user_entity();
$page_owner = elgg_get_page_owner_entity();

if ($page_owner->guid == $viewer->guid) {
	$title = elgg_echo('hj:gallery:albums:friends');
} else {
	$title = elgg_echo('hj:gallery:albums:friends:owner', array($page_owner->name));
}
