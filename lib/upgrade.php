...
function hj_gallery_1361396953()
{
    ...
    $dbprefix = elgg_get_config('dbprefix');
    $files = elgg_get_entities(array('types' => 'object', 'subtypes' => 'hjfile', 'joins' => array("JOIN {$dbprefix}entities ce"), 'wheres' => array("(ce.guid = e.container_guid AND ce.subtype = {$subtypeIdImage})"), 'limit' => 0));
