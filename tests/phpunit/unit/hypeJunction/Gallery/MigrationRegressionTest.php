...
/**
 * Auto-generated migration regression guard for plugin "hypegallery".
 *
...
final class MigrationRegressionTest extends TestCase
{
    ...
    public function testManifestUsesStringLiterals(): void
    {
        ...
        // class-CONSTANT (MyClass::SUBTYPE) in the entities block AUTOLOADS the class
        // and fatals. The magic ::class is a compile-time literal (no autoload) and is
        // the intended form for this plugin's 'class' values (ref e634f6e) — only the
        // 'subtype' values must be plain string literals. Flag ::CONST, allow ::class.
        $src = self::manifestSource();
        ...
        if (preg_match('/[\'"](?:class|subtype)[\'"]\s*=>\s*[\\\\\w]+::[A-Z_]+\b/', $block[1])) {
            $violations[] = 'entities block uses ClassName::CONST — use string literals for subtype (autoloader not wired at manifest parse time)';
        }
