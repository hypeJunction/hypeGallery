...
$options = ['types' => 'object', 'subtypes' => [hjAlbumImage::SUBTYPE], 'owner_guids' => $collab_album ? \elgg_get_logged_in_user_guid() : ELGG_ENTITIES_ANY_VALUE, 'container_guids' => $entity->guid, 'limit' => $limit, 'offset' => $offset, 'count' => true, 'order_by_metadata' => ['name' => 'priority', 'direction' => 'ASC', 'as' => 'integer']];
...
$options['count'] = false;
$list_options = ['list_type' => 'gallery', 'gallery_class' => 'gallery-photostream gallery-manage-album', 'full_view' => true, 'pagination' => true, 'offset_key' => "offset-images-{$entity->guid}"];
