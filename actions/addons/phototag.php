...
if ($tag->save()) {
    ...
    elgg_create_river_item(array('view' => 'framework/river/stream/phototag', 'action_type' => 'stream:phototag', 'subject_guid' => elgg_get_logged_in_user_guid(), 'object_guid' => $tag->guid, 'target_guid' => $tag->container_guid, 'access_id' => $tag->access_id, 'annotation_id' => -1));
